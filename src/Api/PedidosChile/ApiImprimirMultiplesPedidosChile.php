<?php
//src/Api/PedidosChile/ApiImprimirMultiplesPedidos.php
...
class PDF extends FPDF {
    ...
    function agregarPedido($idPedido, $enlace) {
        ...
        $sqlEncabezado = "SELECT 
                            enc.Id_EncabPedidoChile AS NoPedido,
                            enc.FechaOrden,
                            enc.FechaSalida,
                            enc.FechaEnroute,
                            enc.FechaDelivery,
                          ...
                          WHERE enc.Id_EncabPedidoChile = ? AND enc.Estado = 'Activo'";
        ...
        $sqlDetalle = "SELECT 
                       ...
                       INNER JOIN EncabPedidoChile enc ON det.Id_EncabPedidoChile = enc.Id_EncabPedidoChile
                       INNER JOIN Productos prod ON det.Id_Producto = prod.Id_Producto
                       INNER JOIN Embalajes emb ON det.Id_Embalaje = emb.Id_Embalaje
                       WHERE det.Id_EncabPedidoChile = ? AND enc.Estado = 'Activo'
        ...
        $this->Cell(47, 6, 'CHI-' . str_pad($noPedido, 6, '0', STR_PAD_LEFT), 1);
