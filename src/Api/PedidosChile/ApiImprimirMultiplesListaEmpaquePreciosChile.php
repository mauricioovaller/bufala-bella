<?php
//src/Api/PedidosChile/ApiImprimirMultiplesListaEmpaquePrecios.php
...
class PDF extends FPDF
{
    ...
    function agregarListaEmpaquePrecios($idPedido, $enlace) {
        ...
        $sqlDetalle = "SELECT 
                       ...
                       INNER JOIN EncabPedidoChile enc ON det.Id_EncabPedido = enc.Id_EncabPedido
        ...
        $anchos = [12, 12, 40, 54, 14, 14, 14, 12, 12, 12, 17, 15, 15, 17, 14, 15];
        $idxRef = 2;
        $idxPres = 3;
        ...
        // TOTALES
        $anchoTotales = 12+12+40+54+14+14+14+12+12+12;
        $this->SetFont('Arial', 'B', 8);
        ...
        $this->Cell(15, 6, number_format($totalValor, 2), 1, 0, 'R');
        $this->Ln();
