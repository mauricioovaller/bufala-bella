...
$datosPorFecha = consolidacion_obtener_empaque_chile($enlace, $fechaInicio, $fechaFin, $campoFechaBD);

class PDFEmpaqueChile extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(0, 10, utf8_decode('DESPACHOS POR DIA - PEDIDOS CHILE'), 0, 1, 'C');
...
$pdf = new PDFEmpaqueChile('P', 'mm', 'Letter');
...
$nombreArchivo = 'Despachos_Chile_' . date('Y-m-d_His') . '.pdf';
