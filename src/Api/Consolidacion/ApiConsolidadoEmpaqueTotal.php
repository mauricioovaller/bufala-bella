...
$datosLocal = consolidacion_obtener_empaque_local($enlace, $fechaInicio, $fechaFin, $campoFechaBD);
$datosChile = consolidacion_obtener_empaque_chile($enlace, $fechaInicio, $fechaFin, $campoFechaBD);

class PDFEmpaqueConsolidado extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(0, 10, utf8_decode('DESPACHOS POR DIA - CONSOLIDADO'), 0, 1, 'C');
...
$pdf = new PDFEmpaqueConsolidado('P', 'mm', 'Letter');
...
$nombreArchivo = 'Despachos_Consolidado_' . date('Y-m-d_His') . '.pdf';
