...
$datosPorFecha = consolidacion_obtener_produccion_chile($enlace, $fechaInicio, $fechaFin, $campoFechaBD);

class PDFProduccionChile extends FPDF
{
...
$pdf = new PDFProduccionChile('P', 'mm', 'Letter');
