...
try {
    ...
    $rows = consolidacion_obtener_transporte_chile($enlace, $fechaDesde, $fechaHasta, $campoFechaBD);

    $spreadsheet = new Spreadsheet();
    $sheet = $spreadsheet->getActiveSheet();
    $sheet->setTitle("Transporte Chile");
    ...
    $archivoExcel = "Transporte_Chile_" . date("Ymd_His") . ".xlsx";
