<?php
// src/Api/Dashboard/ApiClientesProducto_chile.php - Devuelve los clientes Chile que compraron un producto específico
// Réplica de ApiClientesProducto.php usando tablas Chile
...
// Consulta para obtener clientes Chile que compraron el producto
$sql = "SELECT 
...
// Obtener nombre del producto Chile para referencia
$sqlProducto = "SELECT DescripProducto FROM ProductosChile WHERE Id_Producto = ?";
