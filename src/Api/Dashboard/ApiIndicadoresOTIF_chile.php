<?php
// api/dashboard/ApiIndicadoresOTIF_chile.php - Indicadores OTIF para pedidos Chile
// Réplica de ApiIndicadoresOTIF.php usando tablas Chile (EncabPedidoChile, DetPedidoChile, DetNotaCreditoChile)
