...
define('SMTP_PORT', 25);
define('SMTP_USER', ''); // Tu cuenta nueva
define('SMTP_PASS', ''); // Tu contraseña nueva
...
// Configuración del remitente - Actualizar con nueva cuenta
define('EMAIL_FROM', ''); // Cambia a tu nueva cuenta
