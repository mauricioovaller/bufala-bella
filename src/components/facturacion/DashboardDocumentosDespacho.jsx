...
import { generarCartaResponsabilidad } from '../../services/planillasService';
    ...
    const handleGenerarDocumento = async (tipoDocumento, factura = null) => {
        ...
        try {
            ...
            if (tipoDocumento === 'carta-aerolinea' || tipoDocumento === 'carta-policia') {
                ...
                let tituloDocumento = tipoDocumento === 'carta-aerolinea' ? 'Carta para Aerolínea' : 'Carta para Policía';
